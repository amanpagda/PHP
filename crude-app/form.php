...
<body style="background-color:rgb(43, 9, 77)">
            ...
            <tbody>
                ...
                while ($a = mysqli_fetch_assoc($result)) {
                    ...
                    <tr class="align-middle text-center">
                        ...
                        <td>
                            <a href="?edit=$a[id]" class='btn btn-primary'  data-bs-toggle="modal" data-bs-target="#editproduct" ><i class="fa-solid fa-pen-to-square"></i></a>
    ...
    if(isset($_GET["edit"]) && $_GET["edit"]>0) {
        $sql = "SELECT * FROM `crude` WHERE `id`='$_GET[edit]'";
        $result = mysqli_query($con, $sql);
